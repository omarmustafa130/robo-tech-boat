...
(library Library_1
	...
	(compDef "TX4138" (originalName "TX4138") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "ILIM_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "9" (pinName "ILIM_2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "BS") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "POK") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://datasheet.lcsc.com/szlcsc/XDS-TX4138_C329267.pdf")
		(attr "<Component Height>" "1.65")
		(attr "<STEP Filename>" "TX4138.stp")
